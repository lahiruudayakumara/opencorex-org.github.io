...
import { Home, Menu, Rocket, Target, Users, X } from "lucide-react";
                ...
                return (
                  <Link key={item.id} href={item.id}>
                    <button
                      ...
                      className={`flex items-center gap-2 px-3 py-2 rounded-md text-sm font-medium transition-colors cursor-pointer hover:bg-[#8D153A] hover:text-white ${
